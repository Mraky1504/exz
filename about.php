    ...
    <div class="content">
        <div class="container">
            <div style="border: 2px solid #ccc; padding: 20px; border-radius: 10px;">
                ...
                <p style="font-size: 16px; line-height: 1.6; color: #555; margin-bottom: 15px;">Добро пожаловать на страницу "О нас"! Мы - компания "Автопарк".</p>
                <p style="font-size: 16px; line-height: 1.6; color: #555; margin-bottom: 15px;">Мы являемся крупнейшим автопарком на территории РФ.</p>
                <img src="11.jpg" alt="О нас 1" style="width: 30%; margin-top: 20px;">
                <p style="font-size: 16px; line-height: 1.6; color: #555; margin-top: 20px;">Приезжайте к нам и убедитесь в этом сами!</p>
                <img src="22.jpg" alt="О нас 2" style="width: 30%; margin-top: 20px;">
            </div>
            <?php if (!isset($_SESSION['userId'])): ?>
